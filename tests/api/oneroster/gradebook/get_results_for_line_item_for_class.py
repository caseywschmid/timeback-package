...
def main():
    ...
    print(f"Getting results for class: {class_sourced_id} and line item: {line_item_sourced_id}")
    ...
    request_with_params = TimebackGetResultsForLineItemForClassRequest(
        class_sourced_id=class_sourced_id,
        line_item_sourced_id=line_item_sourced_id,
        query_params=query_params
    )
    resp_filtered = client.oneroster.gradebook.get_results_for_line_item_for_class(request_with_params)
