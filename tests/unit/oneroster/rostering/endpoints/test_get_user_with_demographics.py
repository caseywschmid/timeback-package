...
def test_get_user_with_demographics_success():
    """Test successful user with demographics retrieval."""
    ...
    response = get_user_with_demographics(mock_http, request)
    ...
    assert mock_http.last_path == "/ims/oneroster/rostering/v1p2/users/user123/demographics"


def test_get_user_with_demographics_with_fields_param():
...
def test_get_user_with_demographics_direct_response():
    """Test user with demographics retrieval when API returns user object directly (edge case)."""
    ...
    assert mock_http.last_path == "/ims/oneroster/rostering/v1p2/users/user456/demographics"
