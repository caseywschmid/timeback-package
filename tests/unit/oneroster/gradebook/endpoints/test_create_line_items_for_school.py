...
def test_create_line_items_for_school_success():
    """Test successful line item creation for a school."""
    ...
    resp = create_line_items_for_school(MockHttp(), request)
    
    assert isinstance(resp, TimebackCreateLineItemsForSchoolResponse)
...
def test_create_line_items_for_school_multiple_items():
    """Test creating multiple line items for a school."""
    school_sourced_id = "school-456"
    line_item1 = TimebackCreateLineItemBody(
        sourcedId="line-item-1",
        title="Math Quiz 1",
        assignDate="2024-01-15T00:00:00Z",
...
def test_create_line_items_for_school_with_all_fields():
    """Test line item creation with all optional fields."""
    school_sourced_id = "school-789"
