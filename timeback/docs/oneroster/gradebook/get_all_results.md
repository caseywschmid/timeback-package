## OneRoster — Gradebook - Get All Results
...
- `TimebackGetAllResultsRequest` with optional fields:
...
request_filtered = TimebackGetAllResultsRequest(query_params=query_params)
resp_filtered = client.oneroster.gradebook.get_all_results(request_filtered)
