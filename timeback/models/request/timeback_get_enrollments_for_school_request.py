"""Request model for getting enrollments for a school.
...
class TimebackGetEnrollmentsForSchoolRequest(BaseModel):
    """Request model for getting enrollments for a specific school."""
