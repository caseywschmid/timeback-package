"""Request model for getting results for a class.
...
class TimebackGetResultsForClassRequest(BaseModel):
    """Request model for getting results for a class (paginated list).
