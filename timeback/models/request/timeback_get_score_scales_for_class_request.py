"""Request model for getting score scales for a class.
...
class TimebackGetScoreScalesForClassRequest(BaseModel):
    """Request model for getting score scales for a class (paginated list).
