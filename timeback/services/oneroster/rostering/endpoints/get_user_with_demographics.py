...
def get_user_with_demographics(http: HttpClient, request: TimebackGetUserRequest) -> TimebackGetUserResponse:
    """Fetch a single user with demographics by sourcedId.
    ...
    Returns:
        TimebackGetUserResponse containing the user data with demographics
    """
    ...
    data = http.get(
        f"/ims/oneroster/rostering/v1p2/users/{request.sourced_id}/demographics", params=params
    )
