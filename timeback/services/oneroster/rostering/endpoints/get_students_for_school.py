"""Get Students for School endpoint for OneRoster Rostering.
...
def get_students_for_school(
    http: HttpClient, request: TimebackGetStudentsForSchoolRequest
) -> TimebackGetAllUsersResponse:
    """Fetch students for a specific school.

    GET /ims/oneroster/rostering/v1p2/schools/{schoolSourcedId}/students
    """
    path = f"/ims/oneroster/rostering/v1p2/schools/{request.school_sourced_id}/students"
