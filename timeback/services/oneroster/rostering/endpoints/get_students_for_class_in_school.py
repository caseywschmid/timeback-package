"""Get Students for Class in School endpoint for OneRoster Rostering.
...
def get_students_for_class_in_school(
    http: HttpClient, request: TimebackGetStudentsForClassInSchoolRequest
) -> TimebackGetAllUsersResponse:
    """Fetch students for a class in a specific school.

    GET /ims/oneroster/rostering/v1p2/schools/{schoolSourcedId}/classes/{classSourcedId}/students
    """
    path = f"/ims/oneroster/rostering/v1p2/schools/{request.school_sourced_id}/classes/{request.class_sourced_id}/students"
