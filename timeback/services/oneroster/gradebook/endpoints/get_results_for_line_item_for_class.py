"""Get Results for Line Item for Class endpoint for OneRoster Gradebook.
...
from timeback.models.request import TimebackGetResultsForLineItemForClassRequest
...
def get_results_for_line_item_for_class(
    ...
    """Fetch a paginated list of results for a specific line item and class.

    GET /ims/oneroster/gradebook/v1p2/classes/{classSourcedId}/lineItems/{lineItemSourcedId}/results

    Args:
        http: Injected HTTP client for making requests
        request: Request containing class_sourced_id, line_item_sourced_id, and optional query parameters

    Returns:
        TimebackGetAllResultsResponse containing paginated list of results
    """
    path = f"/ims/oneroster/gradebook/v1p2/classes/{request.class_sourced_id}/lineItems/{request.line_item_sourced_id}/results"
